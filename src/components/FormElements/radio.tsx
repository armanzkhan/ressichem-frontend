        ...
        <div className="relative">
          ...
          <div
            className={cn(
              ...
              {
                "border-blue-900 peer-checked:border-6": variant === "circle",
                "border-dark-5 peer-checked:border-blue-900 peer-checked:bg-gray-2 dark:border-dark-6 dark:peer-checked:bg-dark-2":
                  variant === "dot",
              },
          ...
          >
            <span
              className={cn(
                "hidden size-2.5 rounded-full bg-blue-900",
