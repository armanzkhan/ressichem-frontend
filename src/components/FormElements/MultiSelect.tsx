        ...
        <div className="flex flex-col items-center">
          ...
          <div className="relative z-20 inline-block w-full">
            <div className="relative flex flex-col items-center">
              <div ref={trigger} onClick={toggle} className="w-full">
                <div className="mb-2 flex rounded-[7px] border-[1.5px] border-stroke py-[9px] pl-3 pr-3 outline-none transition focus:border-blue-900 active:border-blue-900 dark:border-dark-3 dark:bg-dark-2">
                  <div className="flex flex-auto flex-wrap gap-3">
                    {selected.map((index) => (
                      <div
                        key={`selected-${index}-${options[index].value}`}
                  ...
                  <div className="flex w-full flex-col">
                    {options.map((option, index) => (
                      <div key={`option-${index}-${option.value}`}>
                        <div
                          className="w-full cursor-pointer rounded-t border-b border-stroke hover:bg-blue-900/5 dark:border-dark-3"
                          onClick={(event) => select(index, event)}
                        >
                          <div
                            className={`relative flex w-full items-center border-l-2 border-transparent p-2 pl-2 ${
                              option.selected ? "border-blue-900" : ""
                            }`}
                          >
